...
<div class="event-form-when" id="em-form-when">
	<p class="em-date-range" name="WTFFFFFFFFFFFFFFFF" >
	...
	<p class="em-time-range">
		...
		<input id="start-time" class="em-time-input em-time-start" type="text" size="8" maxlength="8" name="event_start_time" value="<?php echo ( !empty($EM_Event->start) ? date( $hours_format, $EM_Event->start) : "18:00"); ?>" />
		<?php _e('to','events-manager'); ?>
		<input id="end-time" class="em-time-input em-time-end" type="text" size="8" maxlength="8" name="event_end_time" value="<?php echo ( !empty($EM_Event->end) ? date( $hours_format, $EM_Event->end) : "18:00"); ?>" />
